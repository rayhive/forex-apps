...
const CURRENCY_EXCHANGES = [
  {
    ...
    forexPriceQuote: { currencyPair: 'AUD/USD', bidPrice: 0, askPrice: 0.7311 }
  },
  {
    id: '2',
    name: 'Currency Exchange 2',
    location: 'Hay St, Perth CBD',
    forexPriceQuote: { currencyPair: 'AUD/USD', bidPrice: 0, askPrice: 0.7312 }
  },
  {
    id: '3',
    name: 'Currency Exchange 3',
    location: 'Adelaide Tce, Perth CBD',
    forexPriceQuote: { currencyPair: 'AUD/USD', bidPrice: 0, askPrice: 0.7313 }
  },
  {
    id: '4',
    name: 'Currency Exchange 4',
    location: 'Barrack St, Perth CBD',
    forexPriceQuote: { currencyPair: 'AUD/USD', bidPrice: 0, askPrice: 0.7314 }
  },
  {
    id: '5',
    name: 'Currency Exchange 5',
    location: 'St Georges Tce, Perth CBD',
    forexPriceQuote: { currencyPair: 'AUD/USD', bidPrice: 0, askPrice: 0.7315 }
  }
];
